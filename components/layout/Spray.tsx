...
const navItems: navItemType[] = [
  ...
  },
  {
    index: 2,
    name: "Live",
    icon: <MaterialCommunityIcons name="youtube-tv" size={24} color="white" />,
  },
  {
    index: 3,
    name: "Fund Wallet",
    ...
    >
      ...
      <View style={styles.accountInfo}>
        <View style={styles.balance}>
          ...
          <View style={styles.goRow}>
            <ThemedText style={styles.amount}>₦2,300,000.90</ThemedText>
      ...
      <View style={styles.main}>
        ...
        <View style={styles.currency}>
          ...
          <TouchableOpacity style={styles.currencyValue}>
            <ThemedText>1000</ThemedText>
            <AntDesign
              name="caretdown"
              size={14}
        ...
        <TouchableOpacity style={styles.fundingMode}>
        ...
        <View style={styles.bottomNav}>
          {navItems.map((items) => (
            <TouchableOpacity key={items.index} style={styles.navItem}>
              {items.icon}
